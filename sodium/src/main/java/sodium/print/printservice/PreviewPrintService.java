...
public class PreviewPrintService implements PrintService {
	public static final String DEFAULT_NAME="preview";
	private String name=DEFAULT_NAME;
	private I18NTexts label=new I18NTexts();
	private PrintFormat[] formats=new PrintFormat[]{PrintFormats.HTML};
	public PreviewPrintService(){
		label.put(new I18NText(Locale.ENGLISH,"Preview"));
		label.put(new I18NText(Locale.CHINESE,"预览"));
	}
